...
function createCatCard(text, isHomepage) {
  ...
  // Assemble the widgets and return the card.
    var form = CardService.newSelectionInput()
      .setType(CardService.SelectionInputType.CHECK_BOX)
      .setTitle("Q&A Buddy Planning Scaffold")
      .setFieldName("checkbox_field")
      .addItem("A planning guide for HW5 - we recommend you use this to help plan out your assignment strategy on your calendar. Note that you don't have to use it", "intro", true)
      .addItem("Look over lecture notes and other class_resources", "checkbox_one_value", false)
      .addItem("Watch Chris' assignment 5 video", "checkbox_one_value", false)
      .addItem("Read assignment and understandand deliverables (GE211 geometry, model/view/controller, required structs)", "checkbox_two_value", false)
      .addItem("Work on model (model.cxx/hxx)", "checkbox_three_value", false)
      .addItem("Work on view (view.cxx/hxx)", "checkbox_three_value", false)
      .addItem("Work on controller (controller.cxx/hxx)", "checkbox_three_value", false)
      .addItem("Work on ball (ball.cxx/hxx)", "checkbox_three_value", false)
      .addItem("Write tests and test", "checkbox_three_value", false)
      .addItem("Debug", "checkbox_three_value", false)
      .addItem("Work on submit", "checkbox_three_value", false);
